        ...
        <div className="container hero-container">
          <div className="hero-content">
            <div className="hero-badge">
              <Zap size={16} />
              <span>AI-анализ металлоконструкций</span>
            </div>
            ...
            <p className="hero-description">
              Автоматизированный анализ чертежей металлоконструкций с использованием 
              передовых технологий компьютерного зрения. Быстро, точно, без лишней рутины.
            </p>
        ...
        <div className="container">
          ...
          <div className="steps-grid">
            ...
            <div className="step-item">
              ...
              <h3>Результат</h3>
              <p>Скачайте готовый отчет с детальным анализом и рекомендациями</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="about-grid">
            <div className="about-content">
              ...
              <p className="about-text">
                ПроМонолит — инновационный сервис анализа инженерной документации для 
                металлоконструкций. Мы объединили опыт профессиональных инженеров с 
                передовыми технологиями искусственного интеллекта.
              </p>
              <p className="about-text">
                Наша миссия — ускорить проверку чертежей, снизить количество ошибок 
                и повысить эффективность работы инженеров-проектировщиков по всему миру.
              </p>
